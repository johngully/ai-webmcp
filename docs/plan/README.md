...
- [ ] [Phase 7 — WebMCP availability control](./phase-7-webmcp-control.md) — **IMPLEMENTATION COMPLETE: corrected checks passed; remaining manual Chrome checks WAIVED; coordinator integration pending**
