import { createAvailabilityOperations } from '../availability/availability.operations.server'
...
export function getSurveyOperations() {
  return createSurveyOperations(
    createJsonlSurveyRepository(surveyDataFile),
    createAvailabilityOperations(surveyDataFile),
  )
}
